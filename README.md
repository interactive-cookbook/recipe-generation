...
Create a folder `data` in the main project folder. Add the folder with the [ARA 1.1 corpus](https://github.com/interactive-cookbook/ara/tree/main) to the `data` folder and call it `ara1.1`.

Create a folder `data_ara2` in the main project folder. Add the folder with the [ARA2 corpus](https://github.com/interactive-cookbook/ara2) to the `data_ara2` folder and call it `ara2.0`
